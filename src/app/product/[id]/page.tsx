  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 py-10">
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        {/* Product Details */}
        <div className="w-full lg:w-1/2">
          <h1 className="text-3xl font-bold mb-4">{product.productCardHeading}</h1>
          <p className="text-xl font-semibold text-[#2A254B] mb-6">£{product.productCardPrice}</p>
          ...
          {/* Add to Cart Button */}
          <button className="bg-[#2A254B] text-white px-6 py-3 rounded-md hover:bg-[#1d1a36]">
            Add to Cart
          </button>
        </div>
      </div>
